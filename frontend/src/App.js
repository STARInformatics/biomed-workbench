...
class App extends React.Component {
	constructor(props) {
		...
		this.state = {
			...
			geneList: [
				{id:1, name:'mod0 - Gene Lookup', isLoading:false,
                items:[]},
	...
	handleMondoSearch = () => {
		...
		fetch(SERVICE_URL.concat('/api/data')
            .concat(this.state.searchText))
	...
	handleMondoClick = (mondoItem) => {
        const noHit = [{hit_id: 1, hit_symbol: 'No Result'}];
	...
	render() {
        ...
        <div style={divStyle}>
            <div className="container-fluid">
                <SearchBar
                handleSearch={this.handleMondoSearch} handleTextChange={this.handleTextChange} />
                <div className="row">
        			...
        			<SBGNView
                     sbgn={this.state.sbgn}     highlightedLabel={this.state.selected_gene}/>
            		</div>
            		<div className="col-sm-3">
